    ...
    <main className="min-h-screen bg-white text-black font-[IBM_Plex_Sans,Helvetica,Arial,sans-serif]">
            ...
            <aside className="col-span-12 mt-8 md:col-span-4 md:mt-16">
              <div className="grid grid-cols-2 gap-px bg-black">
                {c.hero.trustBar.badges.map((b, i) => (
                  <div key={b.name} className={`p-3 sm:p-4 ${i % 2 === 0 ? "bg-black text-white" : "bg-white"}`}>
      ...
      <section id="o-nas" className="border-b border-black">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-16 sm:gap-4 sm:px-6 sm:py-20 md:px-10">
          <div className="col-span-12 flex items-baseline justify-between text-[10px] uppercase tracking-[0.2em] text-black/60 sm:text-xs">
            <span>02 / O nas</span>
            <span>—</span>
            <span>{c.about.eyebrow}</span>
          </div>
          <h2 className="col-span-12 mt-6 text-3xl font-bold leading-[1.02] tracking-[-0.02em] sm:mt-8 sm:text-4xl md:col-span-8 md:text-6xl">{c.about.headline}</h2>
          <div className="col-span-12 mt-6 space-y-4 text-base leading-relaxed text-black/80 sm:mt-8 md:col-span-7 md:col-start-1">
            <p className="text-base sm:text-lg">{c.about.lead}</p>
            {c.about.paragraphs.map((p) => <p key={p}>{p}</p>)}
          </div>
          <div className="col-span-12 mt-6 grid grid-cols-2 gap-px self-start bg-black sm:mt-8 md:col-span-5 md:col-start-8">
            {c.about.stats.map((s) => (
      ...
      <section id="nagrody" className="border-b border-black">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-16 sm:gap-4 sm:px-6 sm:py-20 md:px-10">
          ...
          <h2 className="col-span-12 mt-6 text-3xl font-bold leading-[1.02] tracking-[-0.02em] sm:mt-8 sm:text-4xl md:text-6xl">{c.awards.headline}</h2>
          <div className="col-span-12 mt-10 grid grid-cols-12 gap-6 sm:mt-12 sm:gap-4">
      ...
      <section id="uslugi" className="border-b border-black">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-16 sm:gap-4 sm:px-6 sm:py-20 md:px-10">
          ...
          <h2 className="col-span-12 mt-6 text-3xl font-bold leading-[1.02] tracking-[-0.02em] sm:mt-8 sm:text-4xl md:col-span-8 md:text-6xl">{c.services.headline}</h2>
          <p className="col-span-12 mt-6 text-base text-black/70 md:col-span-7">{c.services.subheadline}</p>
          <ul className="col-span-12 mt-10 grid grid-cols-1 gap-px bg-black sm:mt-12 md:grid-cols-3">
            {c.services.items.map((s, i) => (
              <li key={s.id} className="bg-white p-6 sm:p-8">
      ...
      <section id="proces" className="border-b border-black bg-black text-white">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-16 sm:gap-4 sm:px-6 sm:py-20 md:px-10">
          <div className="col-span-12 flex items-baseline justify-between text-[10px] uppercase tracking-[0.2em] text-white/60 sm:text-xs">
            <span>05 / Proces</span>
            <span>—</span>
            <span>{c.process.eyebrow}</span>
          </div>
          <h2 className="col-span-12 mt-6 text-3xl font-bold leading-[1.02] tracking-[-0.02em] sm:mt-8 sm:text-4xl md:col-span-9 md:text-6xl">{c.process.headline}</h2>
          <ol className="col-span-12 mt-10 grid grid-cols-1 gap-px bg-white/20 sm:mt-12 md:grid-cols-5">
            {c.process.steps.map((s) => (
              <li key={s.number} className="bg-black p-5 sm:p-6">
      ...
      <section id="faq" className="border-b border-black">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-16 sm:gap-4 sm:px-6 sm:py-20 md:px-10">
          ...
          <h2 className="col-span-12 mt-6 text-3xl font-bold leading-tight sm:mt-8 sm:text-4xl md:col-span-5 md:text-5xl">{c.faq.headline}</h2>
          <p className="col-span-12 mt-6 text-base text-black/70 md:col-span-4 md:col-start-1">{c.faq.subheadline}</p>
          <div className="col-span-12 mt-4 md:col-span-7 md:col-start-6 md:row-start-2 md:mt-0">
      ...
      <section id="kontakt" className="border-b border-black bg-[#FF3B30] text-white">
        <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-3 px-4 py-20 sm:gap-4 sm:px-6 sm:py-24 md:px-10 md:py-32">
          <div className="col-span-12 flex items-baseline justify-between text-[10px] uppercase tracking-[0.2em] text-white/80 sm:text-xs">
            <span>07 / Kontakt</span>
            <span>—</span>
            <span>{c.cta.primary.eyebrow}</span>
          </div>
          <h2 className="col-span-12 mt-6 text-balance text-4xl font-bold leading-[1.02] tracking-tight sm:mt-8 sm:text-5xl md:col-span-8 md:text-7xl lg:text-8xl">{c.cta.primary.headline}</h2>
          <p className="col-span-12 mt-6 max-w-xl text-base leading-relaxed sm:mt-8 sm:text-lg md:col-span-8">{c.cta.primary.subheadline}</p>
          <div className="col-span-12 mt-8 flex flex-wrap items-center gap-3 sm:mt-10 sm:gap-4 md:col-span-8">
          ...
          <div className="col-span-12 mt-8 grid grid-cols-1 gap-px bg-white/30 sm:mt-10 md:col-span-4 md:col-start-9 md:row-start-3">
